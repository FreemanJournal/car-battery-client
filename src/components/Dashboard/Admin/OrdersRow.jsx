...
export default function OrdersRow({ refetch, order, index }) {
    const { _id, address, phone, quantity, name, email, rate, total, orderID, paid, transactionId, isShipped } = order;
